...
HELP_TEXTS = {
    ...
    "help_ai": (
        ...
        "/ai off — ᴀɪ ᴅɪꜱᴀʙʟᴇ ᴋᴀʀᴏ\n"
        "/ai [ꜱᴀᴡᴀᴀʟ] — ᴅɪʀᴇᴄᴛ ꜱᴀᴡᴀᴀʟ ᴘᴜᴄʜʜᴏ\n\n"
        "ʜɪɴɢʟɪꜱʜ + ꜱᴀᴠᴀɢᴇ ꜱᴛʏʟᴇ 😈\n"
        "ꜱᴇᴛ GROQ_API_KEY ꜰᴏʀ ʀᴇᴀʟ ᴀɪ.\n"
    ),
    "help_approval": (
        "✅ ᴀᴘᴘʀᴏᴠᴀʟ ꜱʏꜱᴛᴇᴍ\n\n"
        "/approval on — ᴇɴᴀʙʟᴇ ᴊᴏɪɴ ʀᴇǫᴜᴇꜱᴛ ᴍᴏᴅᴇ\n"
        "/approval off — ᴅɪꜱᴀʙʟᴇ\n"
        "/approve [ʀᴇᴘʟʏ/@ᴜꜱᴇʀ] — ᴜꜱᴇʀ ᴋᴏ ᴀᴘᴘʀᴏᴠᴇ ᴋᴀʀᴏ\n"
        "/unapprove [ʀᴇᴘʟʏ/@ᴜꜱᴇʀ] — ᴀᴘᴘʀᴏᴠᴀʟ ʜᴀᴛᴀᴏ\n"
        "/approved — ꜱʙ ᴀᴘᴘʀᴏᴠᴇᴅ ᴜꜱᴇʀꜱ ᴅᴇᴋʜᴏ\n\n"
        "ᴊᴏɪɴ ʀᴇǫᴜᴇꜱᴛ ᴀᴀɴᴇ ᴘᴀʀ ɢʀᴏᴜᴘ ᴍᴇɪɴ ɴᴏᴛɪꜰɪᴄᴇꜱᴏɴ ᴀᴀᴛɪ ʜᴀɪ.\n"
        "Approve ʜᴜᴀ ᴜꜱᴇʀ ꜰʟᴏᴏᴅ/ʟᴏᴄᴋ/ʙʟᴀᴄᴋʟɪꜱᴛ ꜱᴇ ᴇxᴇᴍᴘᴛ ʜᴏɢᴀ.\n"
    ),
    "help_grouptools": (
        "🛠 ɢʀᴏᴜᴘ ᴛᴏᴏʟꜱ\n\n"
        "/report — ʀᴇᴘʟʏ ᴋᴀʀᴋᴇ ᴀᴅᴍɪɴꜱ ᴋᴏ ʀᴇᴘᴏʀᴛ ʙʜᴇᴊᴏ\n"
        "/afk [ʀᴇᴀꜱᴏɴ] — ᴀᴘɴᴇ ᴀᴀᴘ ᴋᴏ AFK ꜱᴇᴛ ᴋᴀʀᴏ\n"
        "/warnreasons [ʀᴇᴘʟʏ] — ᴜꜱᴇʀ ᴋᴇ ᴡᴀʀɴ + ʀᴇᴀꜱᴏɴꜱ\n\n"
        "ᴊᴀʙ ᴋᴏɪ AFK ᴜꜱᴇʀ ᴋᴏ ᴛᴀɢ ᴋᴀʀᴇ ᴛᴏ ʙᴏᴛ ʙᴛᴀᴛᴀ ʜᴀɪ.\n"
        "ᴍᴇꜱꜱᴀɢᴇ ʙʜᴇᴊɴᴇ ᴘᴇ AFK ᴀᴜᴛᴏ ʜᴀᴛ ᴊᴀᴛᴀ ʜᴀɪ.\n"
    ),
    "help_utility": (
        "⚙️ ᴜᴛɪʟɪᴛʏ\n\n"
        "/calc [ᴇxᴘʀ] — ᴄᴀʟᴄᴜʟᴀᴛᴏʀ e.g. /calc 50*2+10\n"
        "/time [ᴢᴏɴᴇ] — ᴋɪꜱɪ ᴛɪᴍᴇᴢᴏɴᴇ ᴋᴀ ᴛɪᴍᴇ\n"
        "/tr [ʟᴀɴɢ] [ᴛᴇxᴛ] — ᴛʀᴀɴꜱʟᴀᴛᴇ\n"
        "/weather [ᴄɪᴛʏ] — ᴍᴀᴜꜱᴀᴍ ᴅᴇᴋʜᴏ\n\n"
    ...
    "help_fun": (
        ...
        "ᴋɪꜱɪ ᴋᴏ ʀᴇᴘʟʏ ᴋᴀʀᴏ ʏᴀ ɴᴀᴍ ʟɪᴋʜᴏ.\n"
        "GIF ᴀᴀᴛɪ ʜᴀɪ ꜱᴀᴛʜ ᴍᴇɪɴ! 🎊\n"
    ),
}
...
def action_callback(update: Update, context: CallbackContext):
    ...
    try:
        ...
        if member.status not in ("administrator", "creator") and clicker.id != OWNER_ID:
            query.answer("⛔ ꜱɪʀꜰ ᴀᴅᴍɪɴ ʏᴇ ʙᴜᴛᴛᴏɴ ᴅᴀʙᴀ ꜱᴀᴋᴛᴇ ʜᴀɪɴ!", show_alert=True)
            return
    except Exception:
        query.answer("ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ ꜰᴀɪʟᴇᴅ.", show_alert=True)
        return

    try:
        if action == "unban":
            context.bot.unban_chat_member(chat_id, uid)
            query.answer("✅ ᴜɴʙᴀɴ ʜᴏ ɢᴀʏᴀ!")
            query.edit_message_reply_markup(reply_markup=None)
            query.message.reply_text(
                f"✅ [{to_small_caps(name)}](tg://user?id={uid}) ᴜɴʙᴀɴ ᴋɪʏᴀ ɢᴀʏᴀ\n"
            ...
            query.answer("✅ ᴜɴᴍᴜᴛᴇ ʜᴏ ɢᴀʏᴀ!")
            query.edit_message_reply_markup(reply_markup=None)
            query.message.reply_text(
                f"🔊 [{to_small_caps(name)}](tg://user?id={uid}) ᴜɴᴍᴜᴛᴇ ᴋɪʏᴀ ɢᴀʏᴀ\n"
                f"*ʙʏ:* {to_small_caps(clicker.first_name)}",
                parse_mode=ParseMode.MARKDOWN
            )
            ...
            query.answer("✅ ᴡᴀʀɴ ʜᴀᴛᴀ ᴅɪʏᴀ!")
            query.edit_message_reply_markup(reply_markup=None)
            query.message.reply_text(
                f"✅ [{to_small_caps(name)}](tg://user?id={uid}) ᴋᴀ ᴇᴋ ᴡᴀʀɴ ʜᴀᴛᴀʏᴀ\n"
...
_AI_SYSTEM_PROMPT = (
    "tu 'calypso' hai — ek mast, bindaas, gali-galoch karne wala Telegram group bot. "
    "tu ek dost ki tarah baat karta hai jo kisi se nahi darta. "
    "tu HINGLISH mein baat karta hai — hindi aur english dono mix karke, jaise real dost karte hain. "
    "teri replies SAVAGE, funny, aur seedhi honi chahiye. bilkul waisi jaise koi close dost bolta hai. "
    "gaaliyan dene mein mat sharmao — bc, mc, bkl, chutiya, madarchod, bhosdike, harami jaise words use karo naturally jab zarurat ho. "
    "agar koi stupid cheez puchhe toh seedha bol 'bc yeh bhi nahi pata tera?' ya 'teri maa ki, itna bhi nahi pata?' "
    "agar koi smart cheez puchhe toh thoda impress ho ke jawab do lekin attitude ke saath. "
    "kabhi bhi dry ya boring mat bano. "
    "max 2-3 lines mein reply karo — chota, tight, punchy. "
    "koi formal language nahi. no bullet points. no english-only. "
    "bilkul waise baat karo jaise yaar log WhatsApp pe karte hain."
)

_ROAST_REPLIES = [
    to_small_caps("bc yeh bhi nahi pata tera? google kar na bhai 💀"),
    to_small_caps("teri maa ki, itna bhi nahi pata? sharam kar thodi"),
    to_small_caps("bkl seedha google pe jaa, mera time mat barbad kar"),
    to_small_caps("chutiye, yeh toh khud soch sakta tha tu"),
    to_small_caps("bhai main bot hoon, tera baap nahi — thoda dimag laga"),
    to_small_caps("harami sawaal hai yaar... phir bhi sunta hoon"),
    to_small_caps("abe bc aisa kya poochh diya tune jiske liye main bana hi nahi"),
    to_small_caps("bhosdike, yeh bhi nahi pata? seriously?"),
]

def _call_groq_ai(user_text: str) -> str:
    """Call Groq API for AI response. Falls back to local roast if no key."""
    if not _AI_GROQ_KEY:
        import random
        return random.choice(_ROAST_REPLIES)
    try:
...
def ai_cmd(update: Update, context: CallbackContext):
    ...
    chat_id = update.effective_chat.id
    if not context.args:
        status = "ᴏɴ ✅" if _ai_enabled[chat_id] else "ᴏꜰꜰ ❌"
        update.message.reply_text(
            f"{calypso_header('🤖 ᴀɪ ᴄʜᴀᴛ')}"
            f"ꜱᴛᴀᴛᴜꜱ: *{status}*\n\n"
            "ᴜꜱᴀɢᴇ:\n"
            "`/ai on` — ᴇɴᴀʙʟᴇ ᴀɪ ʀᴇᴘʟɪᴇꜱ\n"
            "`/ai off` — ᴅɪꜱᴀʙʟᴇ ᴀɪ ʀᴇᴘʟɪᴇꜱ\n"
            "`/ai [ꜱᴀᴡᴀᴀʟ]` — ᴅɪʀᴇᴄᴛ ꜱᴀᴡᴀᴀʟ ᴘᴜᴄʜʜᴏ",
            parse_mode=ParseMode.MARKDOWN
        )
        return
    ...
    if first_arg == "on":
        ...
        update.message.reply_text(
            f"{calypso_header('🤖 ᴀɪ ᴄʜᴀᴛ')}"
            + "ᴀɪ ᴀʙ *ᴏɴ* ʜᴀɪ ✅\n"
            + to_small_caps("ab main group mein baat karunga!"),
            parse_mode=ParseMode.MARKDOWN
        )
    elif first_arg == "off":
        ...
        update.message.reply_text(
            f"{calypso_header('🤖 ᴀɪ ᴄʜᴀᴛ')}"
            "ᴀɪ *ᴏꜰꜰ* ᴋᴀʀ ᴅɪʏᴀ ❌\n"
            + to_small_caps("ab main chup rahega"),
            parse_mode=ParseMode.MARKDOWN
        )
    else:
        # Direct question
        question = " ".join(context.args)
        thinking_msg = update.message.reply_text(to_small_caps("sooch raha hoon bc... 🤔"))
        reply = _call_groq_ai(question)
        try:
            thinking_msg.delete()
        except Exception:
            pass
...
def ai_message_handler(update: Update, context: CallbackContext):
    """Auto-reply when AI is on and someone mentions calypso."""
    if not update.message or not update.message.text:
        return
    chat_id = update.effective_chat.id
    if not _ai_enabled.get(chat_id):
        return
    text = update.message.text.lower()
    bot_name = context.bot.username.lower() if context.bot.username else "calypso"
    # Trigger if message mentions bot or is a reply to bot's message
    trigger = False
    if "calypso" in text or bot_name in text:
        trigger = True
    ...
    if not trigger:
        return
    reply = _call_groq_ai(update.message.text)
    update.message.reply_text(reply)
...
def approval_cmd(update: Update, context: CallbackContext):
    ...
    if val == "on":
        ...
        update.message.reply_text(
            "✅ *ᴀᴘᴘʀᴏᴠᴀʟ ꜱʏꜱᴛᴇᴍ ᴏɴ* ᴋᴀʀ ᴅɪʏᴀ\n"
            + to_small_caps("ab join requests group mein dikhegi."),
            parse_mode=ParseMode.MARKDOWN
        )
    elif val == "off":
        _approval_enabled[chat_id] = False
        update.message.reply_text("❌ ᴀᴘᴘʀᴏᴠᴀʟ ꜱʏꜱᴛᴇᴍ ᴏꜰꜰ.")
    else:
...
def approve_cmd(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(
        ...
        f"[{to_small_caps(name)}](tg://user?id={uid}) ᴋᴏ ᴀᴘᴘʀᴏᴠᴇ ᴋᴀʀ ᴅɪʏᴀ.\n"
        + to_small_caps("ab ye flood/lock/blacklist se exempt hai."),
        parse_mode=ParseMode.MARKDOWN
    )
...
def unapprove_cmd(update: Update, context: CallbackContext):
    ...
    update.message.reply_text(
        f"❌ [{to_small_caps(name)}](tg://user?id={uid}) " + to_small_caps("ka approval hata diya."),
        parse_mode=ParseMode.MARKDOWN
    )
...
def approved_list_cmd(update: Update, context: CallbackContext):
    ...
    if not uids:
        update.message.reply_text(to_small_caps("koi approved user nahi abhi."))
        return
...
def tr_cmd(update: Update, context: CallbackContext):
    """/tr [lang] [text] or reply — translate via MyMemory (free)."""
    msg = update.message
    if context.args:
    ...
    try:
        ...
        msg.reply_text(to_small_caps("translation service down hai, thodi der mein try karo"))
...
def weather_cmd(update: Update, context: CallbackContext):
    ...
    try:
        ...
        update.message.reply_text(to_small_caps("city nahi mila ya service down hai"))
...
# GIF URLs - working anime GIFs
_FUN_GIFS = {
    "kiss": [
        "https://media.tenor.com/kCNJ7LNMdFkAAAAd/kiss-anime.gif",
        "https://media.tenor.com/3OxLPPknmjkAAAAd/kiss.gif",
        "https://media.tenor.com/9KIF1GHjmDcAAAAd/kiss-cute.gif",
    ],
    "slap": [
        "https://media.tenor.com/pjbKVW2gR0UAAAAd/slap-anime.gif",
        "https://media.tenor.com/kL5MaRDp5ZYAAAAd/slap.gif",
        "https://media.tenor.com/m5s9mEfHkhMAAAAd/anime-slap.gif",
    ],
    "hug": [
        "https://media.tenor.com/b17OslX8wOQAAAAd/hug-anime.gif",
        "https://media.tenor.com/OHFXMHpvFU4AAAAd/anime-hug.gif",
        "https://media.tenor.com/uXhqaRxhLqkAAAAd/hug-cute.gif",
    ],
    "pat": [
        "https://media.tenor.com/N6B2EmR0TYYAAAAd/pat-anime.gif",
        "https://media.tenor.com/V1P5J0HOvwMAAAAd/anime-head-pat.gif",
        "https://media.tenor.com/MBcm5pO4CCIAAAAd/pat-headpat.gif",
    ],
    "punch": [
        "https://media.tenor.com/pJCQPbz7IG0AAAAd/anime-punch.gif",
        "https://media.tenor.com/4wN4VMXbDz8AAAAd/punch-anime.gif",
        "https://media.tenor.com/X4p_7E_xBW4AAAAd/punch.gif",
    ],
    "cuddle": [
        "https://media.tenor.com/Q0OaKAzNPlIAAAAd/cuddle-anime.gif",
        "https://media.tenor.com/mHBqvPpIVL0AAAAd/cuddle.gif",
        "https://media.tenor.com/qBLFDI2X6f4AAAAd/cuddle-cute.gif",
    ],
    "poke": [
        "https://media.tenor.com/2L_pV7sB0EMAAAAd/poke-anime.gif",
        "https://media.tenor.com/XSijwOPXqq4AAAAd/poke.gif",
        "https://media.tenor.com/AJfQNBlg5EAAAAAd/anime-poke.gif",
    ],
    "highfive": [
        "https://media.tenor.com/sX4IOmJC0oUAAAAd/high-five-anime.gif",
        "https://media.tenor.com/VBqPjwf3WIIAAAAd/anime-high-five.gif",
        "https://media.tenor.com/r6Pu2sQXhHYAAAAd/high-five.gif",
    ],
}
...
def _make_fun_handler(action: str):
    def handler(update: Update, context: CallbackContext):
        ...
        gif_urls = _FUN_GIFS[action][:]
        _random.shuffle(gif_urls)
